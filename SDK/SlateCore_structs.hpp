...
// NumValues: 0x0003
enum class EMaterialStrategy : uint8
{
	None                                     = 0,
	Inherite                                 = 1,
...
// NumValues: 0x0004
enum class ESlateGeometryMaskType : uint8
{
	None                                     = 0,
	Rectangle                                = 1,
	Circle                                   = 2,
...
// NumValues: 0x0004
enum class EDynamicAdaptType : uint8
{
	Close                                    = 0,
...
// NumValues: 0x0003
enum class ETextUpperPolicy : uint8
{
	Default                                  = 0,
	Upper                                    = 1,
...
// NumValues: 0x0003
enum class EFake3DBlurType : uint8
{
...
// NumValues: 0x0003
enum class ELineWidgetOrientation : uint8
{
	Horizontal                               = 0,
	Vertical                                 = 1,
...
// NumValues: 0x0004
enum class ERadialImageFillType : uint8
{
	Radial360                                = 0,
	Horizontal                               = 1,
	Vertical                                 = 2,
...
public:
	...
	uint8                                         bAdaptiveTiling : 1;                               // 0x0070(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
...
struct FInvalidateWidgetReason final
{
public:
	uint8                                         Pad_0[0x1];                                        // 0x0000(0x0001)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
DUMPER7_ASSERTS_FInvalidateWidgetReason;
...
{
public:
	struct FButtonStyle                           ButtonStyle;                                       // 0x0008(0x0298)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FSlateBrush                            DownArrowImage;                                    // 0x02A0(0x0090)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FSlateBrush                            MenuBorderBrush;                                   // 0x0330(0x0090)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FMargin                                MenuBorderPadding;                                 // 0x03C0(0x0010)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
};
...
{
public:
	struct FComboButtonStyle                      ComboButtonStyle;                                  // 0x0008(0x03D0)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FSlateSound                            PressedSlateSound;                                 // 0x03D8(0x0018)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	struct FSlateSound                            SelectionChangeSlateSound;                         // 0x03F0(0x0018)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
};
...
public:
	...
	ETextOverflowPolicy                           OverflowPolicy;                                    // 0x0288(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	struct FTextBlockStyle                        TextStyle;                                         // 0x0868(0x0290)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
};
...
{
public:
	struct FButtonStyle                           UnderlineStyle;                                    // 0x0008(0x0298)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FTextBlockStyle                        TextStyle;                                         // 0x02A0(0x0290)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FMargin                                Padding;                                           // 0x0530(0x0010)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
};
...
// 0x0018 (0x0018 - 0x0000)
struct alignas(0x08) FReplyBase
{
public:
	uint8                                         Pad_0[0x18];                                       // 0x0000(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
DUMPER7_ASSERTS_FReplyBase;

// ScriptStruct SlateCore.Reply
// 0x00B8 (0x00D0 - 0x0018)
struct FReply final : public FReplyBase
{
public:
	uint8                                         Pad_18[0xB8];                                      // 0x0018(0x00B8)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
DUMPER7_ASSERTS_FReply;

// ScriptStruct SlateCore.WindowStyle
// 0x1130 (0x1138 - 0x0008)
struct FWindowStyle final : public FSlateWidgetStyle
{
public:
	struct FButtonStyle                           MinimizeButtonStyle;                               // 0x0008(0x0298)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FButtonStyle                           MaximizeButtonStyle;                               // 0x02A0(0x0298)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FButtonStyle                           RestoreButtonStyle;                                // 0x0538(0x0298)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FButtonStyle                           CloseButtonStyle;                                  // 0x07D0(0x0298)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FTextBlockStyle                        TitleTextStyle;                                    // 0x0A68(0x0290)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FSlateBrush                            ActiveTitleBrush;                                  // 0x0CF8(0x0090)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FSlateBrush                            InactiveTitleBrush;                                // 0x0D88(0x0090)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FSlateBrush                            FlashTitleBrush;                                   // 0x0E18(0x0090)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FSlateColor                            BackgroundColor;                                   // 0x0EA8(0x0028)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FSlateBrush                            OutlineBrush;                                      // 0x0ED0(0x0090)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FSlateColor                            OutlineColor;                                      // 0x0F60(0x0028)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FSlateBrush                            BorderBrush;                                       // 0x0F88(0x0090)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FSlateBrush                            BackgroundBrush;                                   // 0x1018(0x0090)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FSlateBrush                            ChildBackgroundBrush;                              // 0x10A8(0x0090)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
};
...
{
public:
	struct FButtonStyle                           CloseButtonStyle;                                  // 0x0008(0x0298)(Edit, NativeAccessSpecifierPublic)
	struct FSlateBrush                            NormalBrush;                                       // 0x02A0(0x0090)(Edit, NativeAccessSpecifierPublic)
	struct FSlateBrush                            ActiveBrush;                                       // 0x0330(0x0090)(Edit, NativeAccessSpecifierPublic)
	struct FSlateBrush                            ColorOverlayTabBrush;                              // 0x03C0(0x0090)(Edit, NativeAccessSpecifierPublic)
	struct FSlateBrush                            ColorOverlayIconBrush;                             // 0x0450(0x0090)(Edit, NativeAccessSpecifierPublic)
	struct FSlateBrush                            ForegroundBrush;                                   // 0x04E0(0x0090)(Edit, NativeAccessSpecifierPublic)
	struct FSlateBrush                            HoveredBrush;                                      // 0x0570(0x0090)(Edit, NativeAccessSpecifierPublic)
	struct FSlateBrush                            ContentAreaBrush;                                  // 0x0600(0x0090)(Edit, NativeAccessSpecifierPublic)
	struct FSlateBrush                            TabWellBrush;                                      // 0x0690(0x0090)(Edit, NativeAccessSpecifierPublic)
	struct FMargin                                TabPadding;                                        // 0x0720(0x0010)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	float                                         OverlapWidth;                                      // 0x0730(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_734[0x4];                                      // 0x0734(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FSlateColor                            FlashColor;                                        // 0x0738(0x0028)(Edit, NativeAccessSpecifierPublic)
};
