...
public:
	EMovieSceneCaptureProtocolState GetState() const; // (Final, Native, Public, BlueprintCallable, BlueprintPure, Const) // @ 0x14C255E70
	bool IsCapturing() const; // (Final, Native, Public, BlueprintCallable, BlueprintPure, Const) // @ 0x14C975B10
...
public:
	void OnBeginFinalize(); // (Event, Protected, BlueprintEvent) // @ 0x14B5B5E20
	void OnCaptureFrame(); // (Event, Protected, BlueprintEvent) // @ 0x14B5B5E20
	void OnFinalize(); // (Event, Protected, BlueprintEvent) // @ 0x14B5B5E20
	void OnPauseCapture(); // (Event, Protected, BlueprintEvent) // @ 0x14B5B5E20
	void OnPixelsReceived(const struct FCapturedPixels& Pixels, const struct FCapturedPixelsID& ID, const struct FFrameMetrics& FrameMetrics); // (Event, Protected, HasOutParams, BlueprintEvent) // @ 0x14B5B5E20
	void OnPreTick(); // (Event, Protected, BlueprintEvent) // @ 0x14B5B5E20
	bool OnSetup(); // (Native, Event, Protected, BlueprintEvent) // @ 0x141FB4690
	void OnStartCapture(); // (Event, Protected, BlueprintEvent) // @ 0x14B5B5E20
	void OnTick(); // (Event, Protected, BlueprintEvent) // @ 0x14B5B5E20
	void OnWarmUp(); // (Event, Protected, BlueprintEvent) // @ 0x14B5B5E20
	void ResolveBuffer(class UTexture* Buffer, const struct FCapturedPixelsID& BufferID); // (Final, Native, Public, HasOutParams, BlueprintCallable) // @ 0x14C975B50
	void StartCapturingFinalPixels(const struct FCapturedPixelsID& StreamID); // (Final, Native, Public, HasOutParams, BlueprintCallable) // @ 0x14C975DA0
	void StopCapturingFinalPixels(); // (Final, Native, Public, BlueprintCallable) // @ 0x14C975EB0

	class FString GenerateFilename(const struct FFrameMetrics& InFrameMetrics) const; // (Native, Public, HasOutParams, BlueprintCallable, BlueprintPure, Const) // @ 0x14C975760
	struct FFrameMetrics GetCurrentFrameMetrics() const; // (Final, Native, Public, BlueprintCallable, BlueprintPure, Const) // @ 0x14C975AC0
	bool OnCanFinalize() const; // (Native, Event, Protected, BlueprintEvent, Const) // @ 0x1419263F0
...
public:
	class FString GenerateFilenameForBuffer(class UTexture* Buffer, const struct FCapturedPixelsID& StreamID); // (Final, Native, Public, HasOutParams, BlueprintCallable) // @ 0x14C975860
	class FString GenerateFilenameForCurrentFrame(); // (Final, Native, Public, BlueprintCallable) // @ 0x14C9759E0
	void WriteImageToDisk(const struct FCapturedPixels& PixelData, const struct FCapturedPixelsID& StreamID, const struct FFrameMetrics& FrameMetrics, bool bCopyImageData); // (Final, Native, Public, HasOutParams, BlueprintCallable) // @ 0x14C975ED0
...
public:
	class UMovieSceneCaptureProtocolBase* GetAudioCaptureProtocol(); // (Final, Native, Public, BlueprintCallable) // @ 0x14A55CD00
	class UMovieSceneCaptureProtocolBase* GetImageCaptureProtocol(); // (Final, Native, Public, BlueprintCallable) // @ 0x14A55CD20
	void SetAudioCaptureProtocolType(TSubclassOf<class UMovieSceneCaptureProtocolBase> ProtocolType); // (Final, Native, Public, BlueprintCallable) // @ 0x14C975CA0
	void SetImageCaptureProtocolType(TSubclassOf<class UMovieSceneCaptureProtocolBase> ProtocolType); // (Final, Native, Public, BlueprintCallable) // @ 0x14C975D20
...
{
public:
	static class UMovieSceneAudioCaptureProtocolBase* FindAudioCaptureProtocol(); // (Final, Native, Static, Public, BlueprintCallable) // @ 0x14C975700
	static class UMovieSceneImageCaptureProtocolBase* FindImageCaptureProtocol(); // (Final, Native, Static, Public, BlueprintCallable) // @ 0x14C975730
	static float GetCaptureElapsedTime(); // (Final, Native, Static, Public, BlueprintCallable, BlueprintPure) // @ 0x14C975A60
	static int32 GetCaptureFrameNumber(); // (Final, Native, Static, Public, BlueprintCallable, BlueprintPure) // @ 0x14C975A90
	static bool IsCaptureInProgress(); // (Final, Native, Static, Public, BlueprintCallable) // @ 0x14C975AE0
