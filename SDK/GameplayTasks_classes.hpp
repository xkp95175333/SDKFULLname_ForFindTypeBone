...
public:
	void EndTask(); // (Final, Native, Public, BlueprintCallable) // @ 0x14D8E6FD0
	void ReadyForActivation(); // (Final, Native, Public, BlueprintCallable) // @ 0x14D8E7390
...
{
public:
	static class UGameplayTask_ClaimResource* ClaimResource(TScriptInterface<class IGameplayTaskOwnerInterface> InTaskOwner, TSubclassOf<class UGameplayTaskResource> ResourceClass, const uint8 Priority, const class FName TaskInstanceName); // (Final, Native, Static, Public, BlueprintCallable) // @ 0x14D8E6CA0
	static class UGameplayTask_ClaimResource* ClaimResources(TScriptInterface<class IGameplayTaskOwnerInterface> InTaskOwner, const TArray<TSubclassOf<class UGameplayTaskResource>>& ResourceClasses, const uint8 Priority, const class FName TaskInstanceName); // (Final, Native, Static, Public, BlueprintCallable) // @ 0x14D8E6DF0
...
public:
	...
	TMulticastInlineDelegate<void(const struct FGameplayResourceSet& NewlyClaimed, const struct FGameplayResourceSet& FreshlyReleased)> OnClaimedResourcesChange; // 0x0158(0x0010)(BlueprintVisible, ZeroConstructor, InstancedReference, NativeAccessSpecifierPublic)

public:
	static EGameplayTaskRunResult K2_RunGameplayTask(TScriptInterface<class IGameplayTaskOwnerInterface> TaskOwner, class UGameplayTask* Task, uint8 Priority, const TArray<TSubclassOf<class UGameplayTaskResource>>& AdditionalRequiredResources, const TArray<TSubclassOf<class UGameplayTaskResource>>& AdditionalClaimedResources); // (Final, Native, Static, Public, BlueprintCallable) // @ 0x14D8E70C0

	void OnRep_SimulatedTasks(); // (Final, Native, Public) // @ 0x14D8E7370
...
public:
	static class UGameplayTask_SpawnActor* SpawnActor(TScriptInterface<class IGameplayTaskOwnerInterface> TaskOwner, const struct FVector& SpawnLocation, const struct FRotator& SpawnRotation, TSubclassOf<class AActor> Class_0, bool bSpawnOnlyOnAuthority); // (Final, Native, Static, Public, HasDefaults, BlueprintCallable) // @ 0x14D8E73B0

	bool BeginSpawningActor(class UObject* WorldContextObject, class AActor** SpawnedActor); // (Native, Public, HasOutParams, BlueprintCallable) // @ 0x14D8E6BC0
	void FinishSpawningActor(class UObject* WorldContextObject, class AActor* SpawnedActor); // (Native, Public, BlueprintCallable) // @ 0x14D8E6FF0
...
public:
	static class UGameplayTask_WaitDelay* TaskWaitDelay(TScriptInterface<class IGameplayTaskOwnerInterface> TaskOwner, float Time, const uint8 Priority); // (Final, Native, Static, Public, BlueprintCallable) // @ 0x14D8E7560
