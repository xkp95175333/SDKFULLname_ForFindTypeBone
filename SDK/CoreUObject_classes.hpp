...
public:
	...
	class UClass*                                 Class;                                             // 0x0008(0x0008)(NOT AUTO-GENERATED PROPERTY)
	class UObject*                                Outer;                                             // 0x0010(0x0008)(NOT AUTO-GENERATED PROPERTY)
	EObjectFlags                                  Flags;                                             // 0x0018(0x0004)(NOT AUTO-GENERATED PROPERTY)
	class FName                                   Name;                                              // 0x001C(0x0008)(NOT AUTO-GENERATED PROPERTY)
...
public:
	...
	void ExecuteUbergraph(int32 EntryPoint); // (Event, Public, BlueprintEvent) // @ 0x14B5B5E20
...
public:
	...
	int16                                         MinAlignment;                                      // 0x0050(0x0002)(NOT AUTO-GENERATED PROPERTY)
	uint8                                         Pad_52[0x6];                                       // 0x0052(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	class UField*                                 Children;                                          // 0x0058(0x0008)(NOT AUTO-GENERATED PROPERTY)
	uint8                                         Pad_60[0x10];                                      // 0x0060(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	class FField*                                 ChildProperties;                                   // 0x0070(0x0008)(NOT AUTO-GENERATED PROPERTY)
...
{
public:
	uint8                                         Pad_268[0x1B8];                                    // 0x0268(0x01B8)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_C4[0x1C];                                      // 0x00C4(0x001C)(Fixing Size After Last Property [ Dumper-7 ])
...
// Class CoreUObject.ObjectPtrProperty
// 0x0000 (0x0080 - 0x0080)
class UObjectPtrProperty final : public UObjectPropertyBase
{
public:
	static class UClass* StaticClass()
	{
		STATIC_CLASS_IMPL("ObjectPtrProperty")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"ObjectPtrProperty")
	}
	static class UObjectPtrProperty* GetDefaultObj()
	{
		return GetDefaultObjImpl<UObjectPtrProperty>();
	}
};
DUMPER7_ASSERTS_UObjectPtrProperty;
