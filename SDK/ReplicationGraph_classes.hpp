...
public:
	...
	bool                                          bEnableNetDirtySystem;                             // 0x0030(0x0001)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bEnableSubobjectDirtyOptimize;                     // 0x0031(0x0001)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint8                                         Pad_C0[0x418];                                     // 0x00C0(0x0418)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	TArray<struct FConnectionAlwaysRelevantNodePair> AlwaysRelevantForConnectionList;                // 0x04E8(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<class AActor*>                         ActorsWithoutNetConnection;                        // 0x04F8(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
...
{
public:
	class UReplicationGraph*                      ReplicationGraph;                                  // 0x0370(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UNetReplicationGraphConnection*         ConnectionManager;                                 // 0x0378(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

public:
	void ClientCellInfo(const struct FVector& CellLocation, const struct FVector& CellExtent, const TArray<class AActor*>& actors); // (Net, NetReliable, Native, Event, Public, HasDefaults, NetClient) // @ 0x14106BBE0
	void ServerCellInfo(); // (Net, NetReliable, Native, Event, Public, NetServer) // @ 0x14106BD40
	void ServerPrintAllActorInfo(const class FString& str); // (Net, NetReliable, Native, Event, Public, NetServer) // @ 0x14106BD60
	void ServerPrintCullDistances(); // (Net, NetReliable, Native, Event, Public, NetServer) // @ 0x1410000F0
	void ServerSetConditionalActorBreakpoint(class AActor* Actor); // (Net, NetReliable, Native, Event, Public, NetServer) // @ 0x14106BE30
	void ServerSetCullDistanceForClass(class UClass* Class_0, float CullDistance); // (Net, NetReliable, Native, Event, Public, NetServer) // @ 0x14106BEC0
	void ServerSetPeriodFrameForClass(class UClass* Class_0, int32 PeriodFrame); // (Net, NetReliable, Native, Event, Public, NetServer) // @ 0x14106BF90
	void ServerStartDebugging(); // (Net, NetReliable, Native, Event, Public, NetServer) // @ 0x14106C060
	void ServerStopDebugging(); // (Net, NetReliable, Native, Event, Public, NetServer) // @ 0x14106C080
