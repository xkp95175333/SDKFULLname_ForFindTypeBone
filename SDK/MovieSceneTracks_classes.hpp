...
public:
	void SetConstraintBindingID(const struct FMovieSceneObjectBindingID& InConstraintBindingID); // (Final, Native, Public, HasOutParams, BlueprintCallable, BlueprintPure) // @ 0x14C67D000

	const struct FMovieSceneObjectBindingID GetConstraintBindingID() const; // (Final, Native, Public, BlueprintCallable, BlueprintPure, Const) // @ 0x14C67CFA0
...
{
public:
	struct FMovieSceneActorReferenceData          ActorReferenceData;                                // 0x00F0(0x00A8)(NativeAccessSpecifierPrivate)
...
{
public:
	struct FTransform BP_GetTransformOrigin() const; // (Event, Protected, HasDefaults, BlueprintCallable, BlueprintEvent, BlueprintPure, Const) // @ 0x14B5B5E20
...
{
public:
	struct FMovieSceneFloatChannel                TimingCurve;                                       // 0x0118(0x00A8)(NativeAccessSpecifierPublic)
...
public:
	...
	struct FMovieSceneFloatChannel                translation[0x3];                                  // 0x00F8(0x00A8)(NativeAccessSpecifierPrivate)
	struct FMovieSceneFloatChannel                Rotation[0x3];                                     // 0x02F0(0x00A8)(NativeAccessSpecifierPrivate)
	struct FMovieSceneFloatChannel                Scale[0x3];                                        // 0x04E8(0x00A8)(NativeAccessSpecifierPrivate)
	struct FMovieSceneFloatChannel                ManualWeight;                                      // 0x06E0(0x00A8)(NativeAccessSpecifierPrivate)
	uint8                                         Pad_788[0x4];                                      // 0x0788(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	bool                                          bUseQuaternionInterpolation;                       // 0x078C(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_78D[0x3];                                      // 0x078D(0x0003)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	bool                                          bCanBlend;                                         // 0x0088(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_89[0x3];                                       // 0x0089(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         EaseOutDuration;                                   // 0x008C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
public:
	...
	struct FMovieSceneFloatChannel                SoundVolume;                                       // 0x0110(0x00A8)(NativeAccessSpecifierPrivate)
	struct FMovieSceneFloatChannel                PitchMultiplier;                                   // 0x01B8(0x00A8)(NativeAccessSpecifierPrivate)
	bool                                          bSuppressSubtitles;                                // 0x0260(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                          bOverrideAttenuation;                              // 0x0261(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_262[0x6];                                      // 0x0262(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	class USoundAttenuation*                      AttenuationSettings;                               // 0x0268(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TDelegate<void(const TArray<struct FSubtitleCue>& Subtitles, float CueDuration)> OnQueueSubtitles; // 0x0270(0x0010)(ZeroConstructor, InstancedReference, NoDestructor, NativeAccessSpecifierPrivate)
	TMulticastInlineDelegate<void()>              OnAudioFinished;                                   // 0x0280(0x0010)(ZeroConstructor, InstancedReference, NativeAccessSpecifierPrivate)
	TMulticastInlineDelegate<void(const class USoundWave* PlayingSoundWave, const float PlaybackPercent)> OnAudioPlaybackPercent; // 0x0290(0x0010)(ZeroConstructor, InstancedReference, NativeAccessSpecifierPrivate)

public:
	void SetSound(class USoundBase* InSound); // (Final, Native, Public, BlueprintCallable) // @ 0x14C67D0C0
	void SetStartOffset(const struct FFrameNumber& InStartOffset); // (Final, Native, Public, HasDefaults, BlueprintCallable) // @ 0x14C67D140

	class USoundBase* GetSound() const; // (Final, Native, Public, BlueprintCallable, BlueprintPure, Const) // @ 0x14C67CFE0
	struct FFrameNumber GetStartOffset() const; // (Final, Native, Public, HasDefaults, BlueprintCallable, BlueprintPure, Const) // @ 0x149462F30
...
public:
	...
	struct FMovieSceneBoolChannel                 BoolCurve;                                         // 0x00F8(0x0098)(Protected, NativeAccessSpecifierProtected)
...
{
public:
	struct FMovieSceneByteChannel                 ByteCurve;                                         // 0x00F0(0x00A0)(NativeAccessSpecifierPublic)
...
public:
	void SetCameraBindingID(const struct FMovieSceneObjectBindingID& InCameraBindingID); // (Final, Native, Public, HasOutParams, BlueprintCallable) // @ 0x14C67D000

	const struct FMovieSceneObjectBindingID GetCameraBindingID() const; // (Final, Native, Public, BlueprintCallable, BlueprintPure, Const) // @ 0x14C67CFA0
...
public:
	...
	TSubclassOf<class UCameraShake>               ShakeClass;                                        // 0x0110(0x0008)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	ECameraAnimPlaySpace                          PlaySpace;                                         // 0x011C(0x0001)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	void SetShotDisplayName(const class FString& InShotDisplayName); // (Final, Native, Public, BlueprintCallable) // @ 0x14C684270

	class FString GetShotDisplayName() const; // (Final, Native, Public, BlueprintCallable, BlueprintPure, Const) // @ 0x14C684080
...
{
public:
	struct FMovieSceneFloatChannel                RedCurve;                                          // 0x00F0(0x00A8)(NativeAccessSpecifierPrivate)
	struct FMovieSceneFloatChannel                GreenCurve;                                        // 0x0198(0x00A8)(NativeAccessSpecifierPrivate)
	struct FMovieSceneFloatChannel                BlueCurve;                                         // 0x0240(0x00A8)(NativeAccessSpecifierPrivate)
	struct FMovieSceneFloatChannel                AlphaCurve;                                        // 0x02E8(0x00A8)(NativeAccessSpecifierPrivate)
...
{
public:
	struct FMovieSceneByteChannel                 EnumCurve;                                         // 0x00F0(0x00A0)(NativeAccessSpecifierPublic)
...
public:
	...
	struct FMovieSceneEventSectionData            EventData;                                         // 0x0168(0x0090)(NativeAccessSpecifierPrivate)
...
class UMovieSceneEventSubtitleSection final : public UMovieSceneSection
{
public:
	class FText                                   SubtitleContent;                                   // 0x00F0(0x0018)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	bool                                          bNoticeAudio;                                      // 0x0108(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_109[0x3];                                      // 0x0109(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         Priority;                                          // 0x010C(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

public:
	static class UClass* StaticClass()
	{
		STATIC_CLASS_IMPL("MovieSceneEventSubtitleSection")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"MovieSceneEventSubtitleSection")
	}
	static class UMovieSceneEventSubtitleSection* GetDefaultObj()
	{
		return GetDefaultObjImpl<UMovieSceneEventSubtitleSection>();
	}
};
DUMPER7_ASSERTS_UMovieSceneEventSubtitleSection;

// Class MovieSceneTracks.MovieSceneEventSubtitlesTrack
// 0x0000 (0x0080 - 0x0080)
class UMovieSceneEventSubtitlesTrack final : public UMovieSceneEventTrack
{
public:
	static class UClass* StaticClass()
	{
		STATIC_CLASS_IMPL("MovieSceneEventSubtitlesTrack")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"MovieSceneEventSubtitlesTrack")
	}
	static class UMovieSceneEventSubtitlesTrack* GetDefaultObj()
	{
		return GetDefaultObjImpl<UMovieSceneEventSubtitlesTrack>();
	}
};
DUMPER7_ASSERTS_UMovieSceneEventSubtitlesTrack;
...
{
public:
	struct FMovieSceneEventChannel                EventChannel;                                      // 0x00F0(0x0090)(NativeAccessSpecifierPublic)
...
{
public:
	struct FMovieSceneFloatChannel                FloatCurve;                                        // 0x00F0(0x00A8)(Protected, NativeAccessSpecifierProtected)
...
{
public:
	struct FMovieSceneIntegerChannel              IntegerCurve;                                      // 0x00F0(0x0098)(NativeAccessSpecifierPrivate)
...
public:
	void SetLevelNames(const TArray<class FName>& InLevelNames); // (Final, Native, Public, HasOutParams, BlueprintCallable) // @ 0x14C684190
	void SetVisibility(ELevelVisibility InVisibility); // (Final, Native, Public, BlueprintCallable) // @ 0x14C6843B0

	const TArray<class FName> GetLevelNames() const; // (Final, Native, Public, BlueprintCallable, BlueprintPure, Const) // @ 0x14C684050
	ELevelVisibility GetVisibility() const; // (Final, Native, Public, BlueprintCallable, BlueprintPure, Const) // @ 0x14C684160
...
{
public:
	struct FMovieSceneObjectPathChannel           ObjectChannel;                                     // 0x00F0(0x00D0)(NativeAccessSpecifierPublic)
...
public:
	...
	bool                                          bForceSoftPtr;                                     // 0x0098(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	TArray<struct FVectorParameterNameAndCurves>  VectorParameterNamesAndCurves;                     // 0x0100(0x0010)(ZeroConstructor, Protected, NativeAccessSpecifierProtected)
	TArray<struct FColorParameterNameAndCurves>   ColorParameterNamesAndCurves;                      // 0x0110(0x0010)(ZeroConstructor, Protected, NativeAccessSpecifierProtected)
	TArray<struct FTransformParameterNameAndCurves> TransformParameterNamesAndCurves;                // 0x0120(0x0010)(ZeroConstructor, Protected, NativeAccessSpecifierProtected)
...
class UMovieSceneParameterWithMaterialInsSection final : public UMovieSceneParameterSection
{
public:
	struct FMaterialParameterNameAndIns           MaterialParamNameAndIns;                           // 0x0130(0x00A0)(NativeAccessSpecifierPublic)

public:
	static class UClass* StaticClass()
	{
		STATIC_CLASS_IMPL("MovieSceneParameterWithMaterialInsSection")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"MovieSceneParameterWithMaterialInsSection")
	}
	static class UMovieSceneParameterWithMaterialInsSection* GetDefaultObj()
	{
		return GetDefaultObjImpl<UMovieSceneParameterWithMaterialInsSection>();
	}
};
DUMPER7_ASSERTS_UMovieSceneParameterWithMaterialInsSection;
...
{
public:
	struct FMovieSceneParticleChannel             ParticleKeys;                                      // 0x00F0(0x00A0)(NativeAccessSpecifierPublic)
...
{
public:
	struct FMovieSceneObjectPathChannel           MaterialChannel;                                   // 0x00F0(0x00D0)(NativeAccessSpecifierPublic)
...
public:
	...
	bool                                          bForceSoftPtr;                                     // 0x0094(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
{
public:
	struct FMovieSceneSkeletalAnimationParams     Params_0;                                          // 0x00F0(0x00E0)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	class UAnimSequence*                          AnimSequence;                                      // 0x01D0(0x0008)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UAnimSequenceBase*                      Animation;                                         // 0x01D8(0x0008)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	float                                         StartOffset;                                       // 0x01E0(0x0004)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	float                                         EndOffset;                                         // 0x01E4(0x0004)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	float                                         PlayRate;                                          // 0x01E8(0x0004)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         bReverse : 1;                                      // 0x01EC(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Deprecated, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate))
	uint8                                         Pad_1ED[0x3];                                      // 0x01ED(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	class FName                                   SlotName;                                          // 0x01F0(0x0008)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
{
public:
	struct FMovieSceneStringChannel               StringCurve;                                       // 0x00F0(0x00A8)(NativeAccessSpecifierPrivate)
...
{
public:
	struct FMovieSceneFloatChannel                Curves[0x4];                                       // 0x00F0(0x00A8)(NativeAccessSpecifierPrivate)
	int32                                         ChannelsUsed;                                      // 0x0390(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
