...
// NumValues: 0x0005
enum class EFoliageTypeMode : uint8
{
	Share                                    = 0,
	HDReplace                                = 1,
	HDOnly                                   = 2,
...
struct FFoliageImportType final
{
public:
	class FString                                 StringType;                                        // 0x0000(0x0010)(Edit, BlueprintVisible, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UFoliageType*                           FoliageType;                                       // 0x0010(0x0008)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
DUMPER7_ASSERTS_FFoliageImportType;
