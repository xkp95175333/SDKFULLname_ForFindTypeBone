...
{
public:
	static void ExportToDisk(class UTexture* Texture, const class FString& Filename, const struct FImageWriteOptions& Options); // (Final, RequiredAPI, Native, Static, Public, HasOutParams, BlueprintCallable) // @ 0x14B9BA870
