...
public:
	static class UGameMapsSettings* GetGameMapsSettings(); // (Final, Native, Static, Public, BlueprintCallable, BlueprintPure) // @ 0x14C18FAC0

	void SetSkipAssigningGamepadToPlayer1(bool bSkipFirstPlayer); // (Final, Native, Public, BlueprintCallable) // @ 0x14C18FB20

	bool GetSkipAssigningGamepadToPlayer1() const; // (Final, Native, Public, BlueprintCallable, BlueprintPure, Const) // @ 0x14C18FAF0
