...
{
public:
	static class UAndroidPermissionCallbackProxy* AcquirePermissions(const TArray<class FString>& Permissions); // (Final, Native, Static, Public, HasOutParams, BlueprintCallable) // @ 0x14294AEF0
	static bool CheckPermission(const class FString& Permission); // (Final, Native, Static, Public, BlueprintCallable) // @ 0x14294B010
