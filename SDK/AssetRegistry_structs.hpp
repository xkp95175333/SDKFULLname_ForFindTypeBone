...
// NumValues: 0x0003
enum class ECrossPlatformType : uint8
{
	Mobile                                   = 0,
	Desktop                                  = 1,
...
public:
	...
	TSet<class FName>                             RecursiveClassesExclusionSet;                      // 0x0090(0x0050)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, NativeAccessSpecifierPublic)
...
public:
	...
	bool                                          bIncludeSoftEditorOnlyPackageReferences;           // 0x0005(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
