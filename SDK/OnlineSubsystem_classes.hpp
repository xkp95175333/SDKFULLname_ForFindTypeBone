...
{
public:
	void OnMatchEnded(const class FString& Match); // (Event, Public, BlueprintEvent) // @ 0x14B5B5E20
	void OnMatchReceivedTurn(const class FString& Match, bool bDidBecomeActive); // (Event, Public, BlueprintEvent) // @ 0x14B5B5E20
