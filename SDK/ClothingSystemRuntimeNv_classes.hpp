...
public:
	static class UClass* StaticClass()
	{
		STATIC_CLASS_IMPL("ClothingAssetNv")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"ClothingAssetNv")
	}
...
DUMPER7_ASSERTS_UClothingAssetNv;
...
public:
	void DisableGravityOverride(); // (Final, Native, Public, BlueprintCallable) // @ 0x140C994B0
	void EnableGravityOverride(const struct FVector& InVector); // (Final, Native, Public, HasOutParams, HasDefaults, BlueprintCallable) // @ 0x14D76F5E0
	void SetAnimDriveDamperStiffness(float InStiffness); // (Final, Native, Public, BlueprintCallable) // @ 0x146BCD520
	void SetAnimDriveSpringStiffness(float InStiffness); // (Final, Native, Public, BlueprintCallable) // @ 0x146BCD520
...
public:
	static class UClass* StaticClass()
	{
		STATIC_CLASS_IMPL("ClothLODDataNv")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"ClothLODDataNv")
	}
...
DUMPER7_ASSERTS_UClothLODDataNv;
...
public:
	static class UClass* StaticClass()
	{
		STATIC_CLASS_IMPL("ClothPhysicalMeshDataNv")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"ClothPhysicalMeshDataNv")
	}
...
DUMPER7_ASSERTS_UClothPhysicalMeshDataNv;
