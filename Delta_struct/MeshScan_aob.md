...
void **__fastcall sub_1437F1E60(__int64 a1)
{
  void **result; // rax
  ...
  if ( !byte_1570058C0
    ...
    || (v6 = a1,
        v5 = "AIntCharacter",
        v4 = 0x16,
        result = (void **)sub_144CEB360(0x53A6LL, &v6, &v5, &v4),
        byte_15700AC66 != 2) )
  {
    if ( *(_BYTE *)(a1 + 0x130) == 1 )
    {
      result = *(void ***)(a1 + 0x3D8);
      if ( result )
        *((_BYTE *)result + 0x241) &= ~0x80u;
    }
    if ( byte_1570058C0 )
    {
      if ( byte_15700AC67 )
      {
        ...
        v5 = "AIntCharacter";
        v4 = 0x16;
        return (void **)sub_144CEB360(0x53A7LL, &v6, &v5, &v4);
      }
    }
  }
  return result;
...
__int64 __fastcall sub_143A72FD0(__int64 a1, __int64 a2)
{
  __int64 v4; // xmm0_8
  int v5; // eax
  __int64 v6; // rax
  ...
  if ( byte_1570058C0
    && byte_157007337
    && (v9 = a1, v13 = &unk_1513E74D8, v12 = 0x16, sub_144CC5EE0(&v10, 0x1A77LL, &v9, &v13, &v12), byte_157007337 == 2) )
  {
    v4 = v10;
    v5 = v11;
  }
...
__int64 __fastcall sub_143AE2850(float *a1, float a2)
{
  __int64 result; // rax
  float v4; // xmm0_4
  float v5; // xmm0_4
  ...
  __int64 v12[3]; // [rsp+38h] [rbp-28h] BYREF
  float v13; // [rsp+88h] [rbp+28h] BYREF
  char v14; // [rsp+90h] [rbp+30h] BYREF
  void *v15; // [rsp+98h] [rbp+38h] BYREF

  v13 = a2;
  if ( byte_1570058C0 && byte_157007338 )
  {
    v11 = a1;
    v15 = &unk_1513E74D8;
    v14 = 0x16;
    result = sub_144D809E0(0x1A78LL, &v11, &v13, &v15, &v14);
    if ( byte_157007338 == 2 )
      return result;
    a2 = v13;
  }
  *(float *)&v15 = a2;
  *((_BYTE *)a1 + 0x1418) = dword_1560720D8 == 1;
  if ( byte_1570058C0 && byte_15700748B )
  {
    v12[0] = (__int64)a1;
    v11 = (float *)&unk_1513E74D8;
    v14 = 0x16;
    sub_144D809E0(0x1BCBLL, v12, &v15, &v11, &v14);
    if ( byte_15700748B == 2 )
      goto LABEL_15;
    a2 = *(float *)&v15;
  }
  ...
  if ( byte_1570058C0 && byte_15700748C )
  {
    v11 = a1;
    v12[0] = (__int64)&unk_1513E74D8;
    v14 = 0x16;
    sub_144D809E0(0x1BCCLL, &v11, &v15, v12, &v14);
  }
LABEL_15:
  if ( !*((_QWORD *)a1 + 0x1FE) || (result = sub_14313DF20(), (_BYTE)result) )
  {
    v6 = (float *)(*(__int64 (__fastcall **)(float *, __int64 *))(*(_QWORD *)a1 + 0x2F0LL))(a1, v12);
    if ( *v6 == 0.0 && v6[1] == 0.0 && v6[2] == 0.0 && *((_BYTE *)a1 + 0x1414) && ((_BYTE)a1[0xDE] & 2) == 0 )
    {
      sub_143AE1930(a1);
      v7 = *((_BYTE *)a1 + 0x1415) == 0;
      *((_WORD *)a1 + 0x9F2) = 0;
      *((_BYTE *)a1 + 0x13E6) = 0;
      if ( !v7 )
        (*(__int64 (__fastcall **)(float *))(*((_QWORD *)a1 + 0x185) + 0x10LL))(a1 + 0x30A);
      sub_143A43460(a1);
      sub_143A420A0(a1);
      v8 = *((_BYTE *)a1 + 0x13E5) || *((_BYTE *)a1 + 0x13E6);
      *((_BYTE *)a1 + 0x13E4) = v8;
      result = (*(__int64 (__fastcall **)(float *))(*((_QWORD *)a1 + 0x185) + 0x10LL))(a1 + 0x30A);
      if ( !(_BYTE)result )
      {
        sub_143A83360(a1);
        result = (*(__int64 (__fastcall **)(float *))(*(_QWORD *)a1 + 0x10A8LL))(a1);
      }
    }
    else
    {
      v9 = (float *)(*(__int64 (__fastcall **)(float *, __int64 *))(*(_QWORD *)a1 + 0x2F0LL))(a1, v12);
      if ( *v9 == 0.0 && v9[1] == 0.0 && v9[2] == 0.0
        || (v10 = *((_QWORD *)a1 + 0x7B)) == 0
        || (*(_BYTE *)(v10 + 0x240) & 4) == 0 )
      {
        result = ((__int64 (__fastcall *)(float *))sub_143AE08B0)(a1);
      }
      else
      {
        result = (*(__int64 (__fastcall **)(float *))(*((_QWORD *)a1 + 0x185) + 0x10LL))(a1 + 0x30A);
  ...
  *(float *)&v15 = v13;
  if ( !byte_1570058C0
    ...
    || (v11 = a1,
        v12[0] = (__int64)&unk_1513E74D8,
        v14 = 0x16,
        result = sub_144D809E0(0x1BCDLL, &v11, &v15, v12, &v14),
        byte_15700748D != 2) )
  {
    *((_BYTE *)a1 + 0x13E7) = 0;
    if ( !byte_1570058C0 )
    ...
    if ( byte_15700748E )
    {
      ...
      v12[0] = (__int64)&unk_1513E74D8;
      v14 = 0x16;
      result = sub_144D809E0(0x1BCELL, &v11, &v15, v12, &v14);
    }
  }
  if ( byte_1570058C0 )
  {
    if ( byte_15700733A )
    {
      ...
      v15 = &unk_1513E74D8;
      v14 = 0x16;
      return sub_144D809E0(0x1A7ALL, v12, &v13, &v15, &v14);
    }
  }
  return result;
}
